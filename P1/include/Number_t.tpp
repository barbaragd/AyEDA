...
Number_t<N,B,T>::Number_t(bool &overflow, const int dato=0){
    digitos_.resize(N);
...
template <size_t N, size_t B, class T>
char Number_t<N,B,T>::get_digito(unsigned i){
    return digitos_[i];
}


template <size_t N, size_t B, class T>
void Number_t<N,B,T>::set_digito(unsigned i, char d){
    digitos_[i] = d;
}
...
template <size_t N, size_t B, class T>
Number_t<N,B,T> Number_t<N,B,T>::sumar(Number_t<N,B,T> sumando, bool &overflow) const{
...
template <size_t N, size_t B, class T>
Number_t<N,B,T> Number_t<N,B,T>::restar(Number_t<N,B,T> sumando, bool &overflow) const{
    Number_t<N,B,T> resultado(overflow); // para guardar el resultado
...
template <size_t N, size_t B, class T>
void Number_t<N,B,T>::to_base(const int dato, bool &overflow){
    unsigned d = dato;
    unsigned resto;
